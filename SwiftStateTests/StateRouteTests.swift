...
class StateRouteTests: _TestCase
{
    func testInit()
    {
        let route = StateRoute<MyState, String>(transition: .State0 => .State1, condition: nil)
        ...
        let route2 = StateRoute<MyState, String>(transition: .State1 => .State2, condition: false)
        ...
        let route3 = StateRoute<MyState, String>(transition: .State2 => .State3, condition: { transition in false })
